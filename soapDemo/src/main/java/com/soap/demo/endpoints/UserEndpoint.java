package com.soap.demo.endpoints;

import com.concretepage.user_ws.*;
import com.soap.demo.entity.User;
import com.soap.demo.service.IUserService;
...
public class UserEndpoint {
    private static final String NAMESPACE_URI = "http://www.concretepage.com/user-ws";
    ...
    public GetAllUsersResponse getAllUsers() {
        ...
        for (int i = 0; i < userList.size(); i++) {
            ...
            BeanUtils.copyProperties(userList.get(i), objct);
