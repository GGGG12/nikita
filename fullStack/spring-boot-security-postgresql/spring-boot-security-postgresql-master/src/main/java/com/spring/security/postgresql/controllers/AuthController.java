...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    User user = new User(signUpRequest.getUsername(), signUpRequest.getEmail(),
        encoder.encode(signUpRequest.getPassword()),signUpRequest.getSurname(),signUpRequest.getName(),signUpRequest.getPatronymic(),
            signUpRequest.getCountry(),signUpRequest.getCity(),signUpRequest.getZipcode(),signUpRequest.getStreet(),signUpRequest.getHouse(),
...
//    roles.forEach(role -> role.getUserSet().add(user));
